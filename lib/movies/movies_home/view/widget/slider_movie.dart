...
import 'package:movies_app/movies/movies_home/model_view/popular_model_view.dart';
import 'package:movies_app/movies/movies_home/view/widget/slider_item.dart';
...
class _SliderMovieState extends State<SliderMovie> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<PopularModelView>(builder: (_, popularViewModel, __) {
